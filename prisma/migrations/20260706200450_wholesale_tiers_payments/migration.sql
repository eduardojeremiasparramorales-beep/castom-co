...
CREATE TABLE "User" (
    ...
    "wholesaleStatus" TEXT NOT NULL DEFAULT 'none',
    "companyName" TEXT,
    "companyNIT" TEXT,
    "city" TEXT,
    "department" TEXT,
...
-- CreateIndex
CREATE INDEX "WholesaleRequest_userId_idx" ON "WholesaleRequest"("userId");
...
-- AddForeignKey
ALTER TABLE "WholesaleRequest" ADD CONSTRAINT "WholesaleRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
